= Jenkins Essentials instance configuration
...
to properly run the services necessary in the container for Jenkins Essentials
...
link:https://github.com/jenkinsci/essentials-plugin[Essentials plugin].
